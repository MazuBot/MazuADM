...
export const enqueueSingleJob = (exploit_run_id, team_id) => 
  fetchJson('/jobs/enqueue', { method: 'POST', body: JSON.stringify({ exploit_run_id, team_id }) })
export const enqueueExistingJob = (job_id) => fetchJson(`/jobs/${job_id}/enqueue`, { method: 'POST' })
