...
pub fn routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/api/rounds/current", get(get_current_round))
        ...
        .route("/api/flags", get(list_flags).post(submit_flag).patch(update_flags))
        .route("/api/flags/cache/init", post(init_flag_cache))
